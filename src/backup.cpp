...
void position_imu_init(Eigen::Quaterniond *q_init, string imu_topic)
{
	...
	ROS_INFO("GPS node ait for self IMU data ...");
...
int main(int argc, char **argv)
{
    ...
    string pub_pose_topic, gps_global_topic, imu_topic, imu_topic_init;
...
//Publisher
	...
	ros::Publisher imu_init_pub = nh.advertise<sensor_msgs::Imu>(imu_topic_init, 10);
