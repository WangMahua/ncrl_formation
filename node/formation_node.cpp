...
int main(int argc, char **argv)
{
    ...
    float leader_uav_vector_x[5] = {0, 0, 0, 1/2 * 1, 0.5 };  //vector x from leader to uav
    float leader_uav_vector_y[5] = {0, 0, sqrt(3)/4 * 1, -sqrt(3)/4 * 1, -sqrt(3)/4 * 1};  //vector y from leader to uav
