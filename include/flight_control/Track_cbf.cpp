...
void Track_CBF::self_pose_cb(const geometry_msgs::PoseStamped::ConstPtr& msg)
{
    ...
    tf::Quaternion Q(self_pos.pose.orientation.x,
                     self_pos.pose.orientation.y,
                     self_pos.pose.orientation.z,
                     self_pos.pose.orientation.w);
...
geometry_msgs::PoseStamped Track_CBF::getSelfPose(){ return self_pos;}
geometry_msgs::PoseStamped Track_CBF::getTargetPose(){ return target_pos;}
double Track_CBF::getSelfYaw(){return yaw;}

int Track_CBF::QPsolve_vel_track(geometry_msgs::TwistStamped desired_vel_raw, geometry_msgs::TwistStamped* desired_vel)
{
...
int Track_CBF::QPsolve_vel_avoid(geometry_msgs::TwistStamped desired_vel_raw, geometry_msgs::TwistStamped* desired_vel)
{
    Eigen::SparseMatrix<double> hessian_Matrix;
    Eigen::VectorXd gradient;
    Eigen::SparseMatrix<double> linearMatrix;
